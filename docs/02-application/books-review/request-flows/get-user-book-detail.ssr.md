...
a single user-owned book detail in an SSR-based architecture.
...
Handle an authenticated request to retrieve a specific user-owned book
...
`01-domains/books-review/domain-use-cases/get-user-book-detail.md`
